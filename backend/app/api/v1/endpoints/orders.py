...
from app.services.order_service import create_order, get_orders, get_order_by_id, update_order
...
async def update_order(order_id: int, order_data: OrderUpdate):
    try:
        updated_order = update_order(order_id, order_data.customer_name, order_data.status)
