...
export default function OrderContent({ onClose }: OrderContentProps) {
  ...
  if (isOrdered) {
    // ... (keeping the isOrdered return block as is)
      ...
      return (
        <div className="flex items-center justify-center min-h-[70vh] p-8 bg-cream/30">
          ...
          >
            ...
            <p className="text-warm-black/60 text-lg mb-6 leading-relaxed">
              Thank you,{" "}
            ...
            {/* Order Summary List */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 mb-10 shadow-sm border border-beige/50 text-left">
              <h3 className="text-coffee font-serif font-bold mb-4 text-center border-b border-beige pb-2">
                Your Order Summary
              </h3>
              <div className="space-y-3">
                ...
                <div className="border-t border-beige mt-4 pt-4 flex justify-between items-center font-bold text-coffee">
