...
import { Float, Reveal } from "@/components/motion/MotionPrimitives";
    ...
    <section id="home" className="relative overflow-hidden bg-coffee pt-28 text-soft-white sm:pt-32">
      ...
      <div className="relative mx-auto grid min-h-[760px] max-w-7xl items-center gap-12 px-5 pb-16 sm:px-8 lg:grid-cols-[1.05fr_.95fr] lg:pb-20">
        ...
        <div className="relative mx-auto w-full max-w-[520px] lg:ml-auto">
          <Float className="absolute -left-6 top-10 h-28 w-28 rounded-full bg-orange blur-3xl" distance={12} duration={6}>
            <span />
          </Float>
          <Reveal eager direction="left" distance={32} delay={0.18} duration={0.72}>
            <Float duration={6.5} distance={6}>
