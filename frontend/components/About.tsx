    ...
    <section id="about" className="overflow-hidden bg-cream py-20 sm:py-28">
      <div className="mx-auto grid max-w-7xl gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:items-center">
        <div className="relative grid grid-cols-2 gap-4">
          <Reveal className="mt-12" direction="right" distance={28}>
          ...
          <Reveal direction="left" distance={28} delay={0.1}>
            <div className="relative aspect-[3/4] overflow-hidden rounded-[2rem]">
          ...
          <div className="absolute -bottom-5 left-1/2 z-10 -translate-x-1/2">
            <Reveal delay={0.18} distance={16}>
              <div className="rounded-2xl bg-orange px-6 py-4 text-center text-white shadow-xl">
        ...
        <div>
          ...
          <Stagger className="mt-9 grid gap-5" delay={0.06}>
            {values.map(({ icon: Icon, title, text }) => (
              <StaggerItem key={title}>
                <div className="flex gap-4 rounded-2xl border bg-soft-white/60 p-5">
