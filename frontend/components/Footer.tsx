...
import { Coffee, Globe, Share2, MessageSquare, MapPin, Phone, Mail } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2">
              <div className="bg-coffee p-2 rounded-xl">
            ...
            <p className="text-soft-white/60 leading-relaxed">
              Experience the finest handcrafted coffee in our cozy minimalist sanctuary. 
              Bringing warmth to your daily routine since 2026.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-soft-white/60">
              {['Home', 'Menu', 'About Us', 'Contact', 'Terms of Service'].map((link) => {
                const anchor = link === 'Home' ? '#home' : link === 'Menu' ? '#full-menu' : link === 'About Us' ? '#about' : link === 'Contact' ? '#contact' : '#';
                return (
                  <li key={link}>
                    <Link href={anchor} className="hover:text-cream transition-colors">{link}</Link>
                  </li>
                );
              })}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-soft-white/60">
              <li className="flex items-start gap-3">
                ...
                <span>123 Coffee Street, <br />Brew City, BC 45678</span>
              </li>
        ...
        <div className="pt-8 border-t border-soft-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-soft-white/40">
          ...
          <div className="flex gap-8">
            <Link href="#" className="hover:text-soft-white transition-colors">Privacy Policy</Link>
            <Link href="#" className="hover:text-soft-white transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
