...
export const dashboardData = {
  ...
  recentOrders: [
    { id: 'ORD-001', customer: 'Alice Johnson', amount: 12.50, status: 'Completed', time: '10:30 AM' },
    { id: 'ORD-002', customer: 'Bob Smith', amount: 8.00, status: 'Completed', time: '11:15 AM' },
    { id: 'ORD-003', customer: 'Charlie Brown', amount: 15.25, status: 'Pending', time: '12:00 PM' },
    { id: 'ORD-004', customer: 'Diana Prince', amount: 22.00, status: 'Completed', time: '1:30 PM' },
    { id: 'ORD-005', customer: 'Ethan Hunt', amount: 6.50, status: 'Cancelled', time: '2:15 PM' },
  ],
};
