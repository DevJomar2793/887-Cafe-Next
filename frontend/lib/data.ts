...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: '$11.00',
    image: '/images/Pansit Bihin.jpeg',
    category: 'Pasta & Noodles',
  },
  {
    id: 12,
    name: 'Mac and Cheese',
    description: 'Creamy macaroni pasta baked with a blend of premium cheeses.',
    price: '$10.50',
    image: '/images/Mac and Cheese.jpeg',
    category: 'Pasta & Noodles',
  },
  // Pica-Pica
  {
    id: 13,
    name: 'Chicken Popper Fries',
    description: 'Crispy golden fries topped with bite-sized popcorn chicken.',
    price: '$8.50',
    image: '/images/Chicken Popper Fries.jpeg',
    category: 'Pica-Pica',
  },
  {
    id: 14,
    name: 'Fries Overload',
    description: 'Golden fries loaded with cheese sauce, bacon bits, and chives.',
    price: '$9.50',
    image: '/images/Fries Overload.jpeg',
    category: 'Pica-Pica',
  },
  {
    id: 15,
    name: 'Nachos Overload',
    description: 'Crispy tortilla chips smothered in cheese, jalapeños, and salsa.',
    price: '$10.00',
    image: '/images/Nachos Overload.jpeg',
    category: 'Pica-Pica',
  },
  // Rice Meal
  {
    id: 16,
    name: 'Pork Sisig',
    description: 'Sizzling chopped pork with onions, chili, and a squeeze of calamansi.',
    price: '$14.00',
    image: '/images/Pork Sisig.jpeg',
    category: 'Rice Meal',
  },
  {
    id: 17,
    name: 'Pork Pepper Lunch',
    description: 'Sizzling pork steak marinated in a savory pepper sauce.',
    price: '$15.00',
    image: '/images/Pork Pepper Lunch.jpeg',
    category: 'Rice Meal',
  },
];
